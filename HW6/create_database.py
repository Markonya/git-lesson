...
cur = con.cursor()
cur.execute("""CREATE TABLE region (id INT, 'region.name' TEXT);""")
# как пронумеровать id автоматически? как удалить повторяющиеся регионы?
cur.execute("""CREATE TABLE city (id INT, 'city.name' TEXT, region_id TEXT,
FOREIGN KEY (region_id) references region(id));""")
# как пронумеровать id автоматически? Верно связь сделал?
